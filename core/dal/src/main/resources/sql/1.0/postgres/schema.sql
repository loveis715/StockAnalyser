...
CREATE TABLE TEST_SCAN_RESULT
(
ID SERIAL NOT NULL,
STOCK_ID INTEGER NOT NULL,
TEST_SCAN_TASK_ID INTEGER,
TAG VARCHAR(512) NOT NULL,
DAY VARCHAR(32) NOT NULL,
PRICE_CHANGE decimal(6, 4) NOT NULL,
PRIMARY KEY (ID)
);
...
TITLE VARCHAR(64),
CONTENT VARCHAR(256),
NOTE_CATEGORY VARCHAR(16) NOT NULL,
LOCK_VERSION INTEGER NOT NULL DEFAULT 1,
PRIMARY KEY (ID)
);
...
ALTER TABLE TEST_SCAN_RESULT ADD FOREIGN KEY (STOCK_ID) REFERENCES STOCK (ID);
ALTER TABLE TEST_SCAN_RESULT ADD FOREIGN KEY (TEST_SCAN_TASK_ID) REFERENCES TEST_SCAN_TASK (ID);
