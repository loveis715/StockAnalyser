Ext.define('jewelry.view.management.HalfDayScanPanel', {
    extend: 'Ext.panel.Panel',
    requires: [
        'jewelry.view.management.HalfDayScanViewModel',
        'jewelry.view.management.HalfDayScanPanelController'
    ],

    controller: 'halfDayScanPanel',
    ...
    items: [{
        ...
        padding: '10 0 0 0',
        text: jewelry.Messages.labels.halfDayScan
    }, {
        xtype: 'displayfield',
